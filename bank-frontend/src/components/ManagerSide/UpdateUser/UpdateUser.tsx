...
const UpdateUser = (props: UpdateUser) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        props.onUpdate(accType,prefix,firstName,lastName,contactNo,email,dob,address,city,state);
        setAccType('');
        setPrefix('');
        setFirstName('');
        setLastName('');
            ...
            <div className='card'>
                <div className='card-body pd-card'>
                    ...
                    <div className="bm-cta-container mt-4">
                        <button className="bm-cta__cta"  type='submit'>
                            <span>Save</span>
                        </button>
                        <a className="bm-cta__cta" href="#" onClick={navigateToDisplay}>
                            <span>Display User Inofrmation</span>
                        </a>
                    </div>
                    </form>
                </div>
